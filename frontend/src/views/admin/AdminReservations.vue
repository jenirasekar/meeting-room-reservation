...
const filteredReservations = computed(() => {
  if (!searchQuery.value.trim()) return store.reservations;
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="relative max-w-sm mb-6">
      ...
      <input
        ...
        placeholder="Search by title, user or room..."
      />
    </div>
    ...
    <div v-else-if="!filteredReservations.length" class="text-center py-16">
      ...
      <h3 class="text-lg font-semibold text-surface-700 mb-1">No matching bookings</h3>
      <p class="text-surface-400">Try a different search term.</p>
    </div>

    <!-- Reservation list -->
    <div v-else class="space-y-3">
      <div v-for="res in filteredReservations" :key="res.id" class="card hover:shadow-soft-lg transition-all">
